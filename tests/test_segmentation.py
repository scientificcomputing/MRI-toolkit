...
def test_segmentation_refinement(tmp_path, mri_data_dir: Path, seg_type: str):
    ...
    fs_input = Segmentation(
        data=fs_input.data, affine=fs_input.affine
    )  # Convert to Segmentation type to access refinement methods
