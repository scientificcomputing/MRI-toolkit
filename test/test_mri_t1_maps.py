...
def test_looklocker_t1map(tmp_path, mri_data_dir: Path):
    ...
    ref_output = (
        mri_data_dir / "mri-dataset/mri_dataset/derivatives/sub-01" / "ses-01/sub-01_ses-01_acq-looklocker_T1map_nICE.nii.gz"
    )
...
def test_looklocker_t1map_postprocessing(tmp_path, mri_data_dir: Path):
    ...
    ref_output = (
        mri_data_dir / "mri-dataset/mri_dataset/derivatives/sub-01" / "ses-01/sub-01_ses-01_acq-looklocker_T1map.nii.gz",
    )
...
def test_mixed_t1map(tmp_path, mri_data_dir: Path):
    ...
    ref_output = (
        mri_data_dir / "mri-dataset/mri_dataset/derivatives/sub-01" / "ses-01/sub-01_ses-01_acq-mixed_T1map_raw.nii.gz",
    )
